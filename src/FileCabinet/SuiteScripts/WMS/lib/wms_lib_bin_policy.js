 ...
 * (customrecord_wms_bin_policy, section 3.9b) and the bin-state projection
 * (customrecord_wms_bin_state, section 3.2b) from cache and passes them in here; this
...
define([], function () {
     ...
     *
     * @param {Object} policy       - { singleSku, singleBatch, ... } (section 3.9b booleans)
